# Release Notes — Smara CLI v1.20.17

Update Smara CLI v1.20.17 membawa peningkatan fitur, stabilitas, dokumentasi, workflow automation, dan packaging release agar instalasi maupun \ lebih konsisten lintas platform.
...
- Tests: \ok  	github.com/gede-cahya/Smara-CLI/internal/web	0.025s
ok  	github.com/gede-cahya/Smara-CLI/cmd/smara	0.021s ✓
- Web build: \ ✓
- Docs check: \ ✓
