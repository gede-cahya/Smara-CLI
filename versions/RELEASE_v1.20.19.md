# Release Notes — Smara CLI v1.20.19

Update Smara CLI v1.20.19 membawa peningkatan fitur, stabilitas, dokumentasi, workflow automation, dan packaging release agar instalasi maupun \ lebih konsisten lintas platform.
