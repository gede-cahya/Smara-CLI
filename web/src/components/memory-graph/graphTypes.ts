...
export interface MemGraphMeta { mode?: string; node_limit?: number; edge_limit?: number; min_weight?: number; total_nodes?: number; total_edges?: number; truncated_nodes?: boolean; truncated_edges?: boolean; virtual_edges?: number; isolated_before_hints?: number }
