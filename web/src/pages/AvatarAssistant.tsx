  ...
  return (
    <div className="h-full overflow-y-auto p-6 space-y-5">
      <div className="flex items-center justify-between">
        <div><div className="flex items-center gap-2 text-cyan-200 font-semibold"><Bot className="w-5 h-5" /> Anime 3D Character Assistant</div><p className="text-sm text-gray-400 mt-1">Avatar VRM Smara, state/expression sync, lip-sync TTS, gesture feedback, speech bubble, dan light-mode toggle.</p></div>
      ...
      <div className="grid xl:grid-cols-[1.15fr_.85fr] gap-5">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-3xl border border-white/10 bg-black/25 p-4 text-xs text-gray-400">Model aktif: VRM Smara dari <code>/api/avatar/model</code>. Runtime animation aktif: idle tangan natural, blink, smile, dan mouth shape A/I/U/E/O saat speaking.</div>
        </div>
      </div>
    </div>
  )
